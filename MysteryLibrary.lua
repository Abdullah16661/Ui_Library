...
ImageLabel.Image = "rbxassetid://12166869331"
...
if game:GetService("CoreGui"):FindFirstChild("Treasure hub") then
    game:GetService("CoreGui"):FindFirstChild("Treasure hub"):Destroy()
end
